...
export default function AstronautChatbot() {
  ...
  const qaPairs = [
    ...
    {
      keywords: ["skill", "technology", "tech", "programming", "language", "framework", "ai", "data science"],
      answer:
        "Bhagyashree is proficient across 6 core technical domains:\n1. Data Science & AI/ML: Pandas, NumPy, Scikit-Learn, EDA, Data Visualization\n2. Full-Stack Development: MERN Stack (MongoDB, Express, React, Node.js), REST APIs, JWT Auth\n3. Programming Languages: Python, C++, SQL\n4. Infrastructure & Ops: ServiceNow, Infrastructure Monitoring, SLA Incident Management\n5. Cloud & Tools: AWS (EC2, S3, VPC), Git, GitHub, Power BI, Postman, Jupyter\n6. UI/UX Design: Figma, Wireframing, User Research & Interactive Prototyping.",
    },
    {
